...
RUN curl -LJo /usr/local/bin/lw-scanner https://github.com/lacework/lacework-vulnerability-scanner/releases/download/v0.2.1/lw-scanner-linux-$(dpkg --print-architecture) && chmod +x /usr/local/bin/lw-scanner
